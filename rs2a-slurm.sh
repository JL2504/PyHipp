...
#SBATCH -J "RPLS2"   # job name

## /SBATCH -p general # partition (queue)
#SBATCH -o RPLS2-slurm.%N.%j.out # STDOUT
#SBATCH -e RPLS2-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:613102755229:awsnotify --message "RPLS2JobDone"
